...
import itr.dev.ViewCalifSimple1_Xp;
import itr.dev.ViewCalifSimple_Impl;


/**
 * The persistent class for the view_calif_simple_1_3ps database table.
 * 
 */
@ReadOnly
@Entity
@Table(name="view_calif_simple_1_3ps")
@NamedQueries
({
@NamedQuery(name="ViewCalifSimple1_3p.findAll", query="SELECT v FROM ViewCalifSimple1_3p v"),
@NamedQuery(name="ViewCalifSimple1_3p.findbyAlumnoID", query="SELECT v FROM ViewCalifSimple1_3p v where v.alumnoId = :alumnoid"),
})
public class ViewCalifSimple1_3p extends ViewCalifSimple_Impl implements Serializable {
